...
* [`src/cljs/tones_lab/`](src/cljs/tones_lab/): SPA source files (ClojureScript,
[re-frame](https://github.com/Day8/re-frame))
  - [`core.cljs`](src/cljs/tones_lab/core.cljs): contains the SPA entry point, `init`
...
7. Clone this repo and open a terminal in the `clynth` project root directory
...
The `debug?` variable in [`config.cljs`](src/cljs/tones_lab/config.cljs) defaults to `true` in
...
```clj
(ns clynth.example
  (:require [clynth.config :as config])
